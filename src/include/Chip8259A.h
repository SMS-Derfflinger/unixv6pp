...
extern "C" void _chip8259a_init();
extern "C" void _chip8259a_irq_enable(unsigned int irq);
extern "C" void _chip8259a_irq_disable(unsigned int irq);
